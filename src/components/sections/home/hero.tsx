...
export default function Hero() {
  return (
    <section className="w-full overflow-hidden bg-light-gray">
      <div className="md:w-[90%] mx-auto flex flex-col items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-8 lg:py-20 xl:py-24">
        {/* Left — content */}

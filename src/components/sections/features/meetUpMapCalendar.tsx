          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16 xl:gap-20">
            <div className="relative z-10 w-full lg:max-w-xl lg:flex-1 xl:max-w-2xl">
              ...
              <p className="mt-2 text-base leading-relaxed text-zinc-600 sm:mt-6 sm:text-md lg:text-md lg:leading-relaxed">
                Golf is a social sport, yet finding players who match your skill
                level, or securing a game when traveling for business is
                notoriously difficult. GolfSwipe’s Interactive Meet-up Map
                solves the isolation of the game.
              </p>
            </div>
            ...
            <div className="relative z-10 flex w-full justify-center lg:flex-1 lg:justify-end">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl">
                ...
                <div className="relative aspect-4/5 w-full overflow-hidden rounded-3xl shadow-[0_24px_60px_-20px_rgba(3,55,43,0.35)] sm:aspect-5/6 lg:aspect-square">
                  ...
                  <div
                    aria-hidden="true"
                    className="absolute inset-0 bg-linear-to-t from-[#03372b]/45 via-transparent to-[#8cc129]/10"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-14 xl:gap-20">
            <div className="relative z-10">
              ...
              <p className="mt-5 text-base leading-relaxed text-white/75 sm:mt-6 sm:text-md">
                With our live, geo-located map, you can drop a pin at your local
                course or search for players in any city you visit. Have a tee
                time booked but need to fill a slot? Post it to the Community
                Calendar and let compatible local players join your game.
              </p>
              <p className="mt-2 text-base leading-relaxed text-white/75 sm:mt-6 sm:text-md">
                From casual weekend rounds to high-level networking, GolfSwipe
                connects you with passionate golfers around the corner or across
                the globe.
              </p>
            </div>
            ...
            <div className="relative z-10 flex justify-center lg:justify-end">
              <div className="relative w-full">
                ...
                <div
                  aria-hidden="true"
                  className="absolute inset-0 rounded-4xl bg-linear-to-br from-[#8cc129]/25 via-transparent to-[#c4e86a]/15 blur-2xl"
                />

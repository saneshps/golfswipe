    ...
    <>
      ...
      <section className="relative w-full overflow-hidden bg-white">
        ...
        <div className="relative mx-auto px-4 py-16 sm:px-6 sm:py-20 md:w-[90%] lg:w-[90%] lg:px-8 lg:py-28 xl:w-[90%] 2xl:w-[85%]">
          ...
          <div className="mt-5 grid grid-cols-1 items-center gap-10 md:mt-12 lg:mt-25 lg:grid-cols-2 lg:gap-14 xl:gap-20">
            {/* Image */}
            <div className="relative z-10 order-2 flex justify-center lg:order-1 lg:justify-start">
              <div className="relative w-full">
                <div className="relative overflow-hidden rounded-4xl border border-[#03372b]/10 bg-white shadow-[0_20px_50px_-12px_rgba(3,55,43,0.15)] sm:rounded-2xl">
                  <Image
            ...
            <div className="relative z-10 order-1 lg:order-2">
              ...
              <p className="mt-5 text-base leading-relaxed text-[#03372b]/70 sm:mt-6 sm:text-lg">
                See exactly how your game evolves over time with clear trends
                and insights. Celebrate your best rounds, spot where you’re
                improving, and share your achievements straight to friends or
                the wider GolfSwipe community.
              </p>
            </div>
          </div>
